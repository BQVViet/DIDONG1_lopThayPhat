...
public class cartActivity extends AppCompatActivity {
    ...
    private int totalAmount = 0; // Biến lưu tổng tiền
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 👉 Liên kết sang paymentActivity
        btnCheckout.setOnClickListener(v -> {
            if (cartList.isEmpty()) {
                Toast.makeText(this, "Không có sản phẩm để thanh toán", Toast.LENGTH_SHORT).show();
            } else {
                Intent intent = new Intent(cartActivity.this, paymentActivity.class);
                intent.putExtra("cartList", new ArrayList<>(cartList)); // Phải cast sang ArrayList vì Serializable
